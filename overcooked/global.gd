...
var VegDictionary = {
	...
	"BurgerLNM" : preload("res://Overcooked Assets/Food/Burgers/Burger(LettuceNoMeat).glb"),
	...
	"BurgerTNM" : preload("res://Overcooked Assets/Food/Burgers/Burger(TomatoNoMeat).glb"),
	"BurgerTLNM" : preload("res://Overcooked Assets/Food/Burgers/Burger(LettuceAndTomatoNoMeat).glb"),
